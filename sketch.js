...
function preload()
{
  ...
  estar = loadAnimation("empty.png")   
  ostar = loadAnimation("one_star.png")
  tstar = loadAnimation("stars.png")
...
function setup() 
{
  ...
  stardisplay.addAnimation('empty', estar);
  stardisplay.addAnimation('one', ostar);
  stardisplay.addAnimation('two', tstar);
